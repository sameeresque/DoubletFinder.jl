...
The module has been constructed to utilize parallel computing capabilities if these are available at your disposal. The following graph demonstrates the comparison between the performance on an `Intel(R) Xeon(R) CPU E5-2680 v2 @ 2.80GHz` using 8 cores vs a single core for different number of species.
